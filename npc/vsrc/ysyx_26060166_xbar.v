module ysyx_26060166_xbar(
  ...
  always@(*)begin
	if(araddr >= 32'h20000fff || araddr <= 32'h0f000000 || araddr <= 32'h20000000 && araddr >= 32'h0fffffff)
	  TO_device();
	if(awaddr >= 32'h20000fff || awaddr <= 32'h0f000000 || awaddr <= 32'h20000000 && awaddr >= 32'h0fffffff)
	  TO_device();
  end
