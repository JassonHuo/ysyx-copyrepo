...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div	   , R, //R(rd) = (src2 != 0 ? ((int32_t)src1 / (int32_t)src2): (int32_t)-1));
		   R(rd) = (src2 == 0) ? (int32_t)-1 : 
		           ((uint32_t)src1 == 0x80000000 && (uint32_t)src2 == 0xFFFFFFFF) ? src1 :
