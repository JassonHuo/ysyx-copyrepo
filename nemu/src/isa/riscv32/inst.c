...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //RV32M
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem	   , R, R(rd) = (src2 != 0 ? ((int32_t)src1 - (uint32_t)src1 / (uint32_t)src2 * (int32_t)src2): (int32_t)src1));
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div	   , R, R(rd) = (src2 != 0 ? ((int32_t)src1 / (int32_t)src2): 0xFFFFFFFF));
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2 != 0 ? ((uint32_t)src1 / (uint32_t)src2): 0xFFFFFFFF));
