...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 000 ????? 01100 11", sll	   , R, R(rd) = src1 << BITS(src2, 4, 0));
  ...
  //RV32M
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem	   , R, R(rd) = src1 - src1 / src2 * src2);
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01000 11", divu   , R, R(rd) = (uint32_t)src1 / (uint32_t)src2);
